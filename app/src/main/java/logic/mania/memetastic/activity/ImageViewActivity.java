            ...
            case R.id.action_share: {
                if (page != null) {
                   _bitmap = page._bitmap;
                    //((App) getApplication()).shareBitmapToOtherApp(_bitmap, ImageViewActivity.this);
                    String bitmapPath = MediaStore.Images.Media.insertImage(getContentResolver(), _bitmap,"title", null);
