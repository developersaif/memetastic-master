...
import logic.mania.memetastic_test.BuildConfig;
import logic.mania.memetastic_test.R;
import logic.mania.opoc.format.markdown.SimpleMarkdownParser;
import logic.mania.opoc.preference.GsPreferenceFragmentCompat;
import logic.mania.opoc.util.ActivityUtils;
...
public class MoreInfoFragment extends GsPreferenceFragmentCompat<AppSettings> {
    ...
    public Boolean onPreferenceClicked(Preference preference, String key, int keyResId) {
        ...
        if (isAdded() && preference.hasKey()) {
            switch (keyToStringResId(preference)) {
                ...
                case R.string.pref_key__more_info_share_app: {
    ...
    private void shareAppNow() {
        try {
            ...
            String shareMessage = "Hey!! Install this app for creating  your own Memes for everyone and enjoy by share it everywhere with your friends and family...\n ";
