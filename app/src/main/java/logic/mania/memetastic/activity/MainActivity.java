...
import logic.mania.opoc.format.markdown.SimpleMarkdownParser;
import logic.mania.opoc.ui.LinearSplitLayout;
import logic.mania.opoc.util.AndroidSupportMeWrapper;
import logic.mania.opoc.util.FileUtils;
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    Uri uri = FileProvider.getUriForFile(getApplicationContext(), getString(R.string.app_fileprovider), photoFile);
